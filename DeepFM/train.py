...
file = 'E:/BI代码集/L6预测全家桶与机器学习四大神器/DeepModel/DeepFM/criteo_sampled_data.csv'
read_part = True
sample_num= 1000000
test_size = 0.1
...
# ---------------build model----------
model = DeepFM(feature_columns, k=k, hidden_units=hidden_units, dnn_dropout=dnn_dropout, residual=True)
model.summary()
